    ...
    >
      <div>
        <div className='relative'>
          ...
          {/* <span className='absolute bootom-0 left-0 h-1 bg-blue-500 w-full transition-all duration-[10s]'></span> */}
          <span className={`absolute bottom-0 left-0 h-1 bg-blue-500 w-full transition-all duration-[10s] ${loading ? 'animate-loading' : ''}`}></span>
        </div>
