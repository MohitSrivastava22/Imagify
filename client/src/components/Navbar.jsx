...
const Navbar = ({ interactiveRef, descriptionRef, testimonialsRef }) => {
    ...
    return (
        <div className='flex items-center justify-between py-4'>
            ...
            {showSectionButtons && (
                <div className='hidden sm:flex flex-row items-center gap-2 sm:gap-6 mt-2 sm:mt-0'>
                    <button
                        onClick={() => scrollToSection(descriptionRef)}
                        className='text-base sm:text-xl font-medium hover:scale-105 transition-all duration-700'
                    >
                        Description
                    </button>
                    <button
