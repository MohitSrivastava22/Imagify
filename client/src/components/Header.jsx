...
const Header = () => {
  ...
  return (
      ...
      <button onClick={() => onClickHandler()} className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex item-center gap-2 rounded-full hover:scale-105 transition-all hover:shadow-2xl'>Generate Images
